"use strict";(()=>{var e={};e.id=984,e.ids=[984],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},11864:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>u,patchFetch:()=>y,requestAsyncStorage:()=>x,routeModule:()=>f,serverHooks:()=>h,staticGenerationAsyncStorage:()=>m});var o={};i.r(o),i.d(o,{POST:()=>g,runtime:()=>c});var a=i(49303),r=i(88716),n=i(60670),s=i(87070),l=i(89484),d=i(16594),p=i(69806);let c="nodejs";async function g(e){let t;try{t=await e.json()}catch{return s.NextResponse.json({ok:!1,error:"Invalid request body"},{status:400})}let i=String(t?.email||"").trim();if(!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i))return s.NextResponse.json({ok:!1,error:"Please enter a valid email."},{status:400});let o=(0,l.KU)(i),a=await (0,d.y)({to:i,subject:`Your Shanky verification code \xb7 ${o}`,html:(0,p.F)(o),text:`Your Shanky verification code is ${o}. It expires in 10 minutes.`});return a.ok?s.NextResponse.json({ok:!0,dev:!!a.dev,devCode:a.dev?o:void 0}):s.NextResponse.json({ok:!1,error:a.error},{status:502})}let f=new a.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/send-otp/route",pathname:"/api/send-otp",filename:"route",bundlePath:"app/api/send-otp/route"},resolvedPagePath:"/Users/bhavankumarganesan/sst-projetcs/void-store/app/api/send-otp/route.js",nextConfigOutput:"",userland:o}),{requestAsyncStorage:x,staticGenerationAsyncStorage:m,serverHooks:h}=f,u="/api/send-otp/route";function y(){return(0,n.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:m})}},16594:(e,t,i)=>{i.d(t,{C:()=>l,y:()=>s});var o=i(82591);let a=process.env.RESEND_API_KEY,r=process.env.EMAIL_FROM||"Shanky <onboarding@resend.dev>",n=a?new o.R(a):null;async function s({to:e,subject:t,html:i,text:o}){if(!n)return console.log("\n\uD83D\uDCE7 [DEV] Email skipped (no RESEND_API_KEY)."),console.log("   To     :",e),console.log("   Subject:",t),o&&console.log("   Body   :",o.slice(0,400)),{ok:!0,dev:!0};try{let{data:a,error:s}=await n.emails.send({from:r,to:Array.isArray(e)?e:[e],subject:t,html:i,text:o});if(s)return console.error("Resend error:",s),{ok:!1,error:s.message||"Email send failed"};return{ok:!0,id:a?.id}}catch(e){return console.error("Resend threw:",e),{ok:!1,error:e.message||"Email send failed"}}}let l=e=>"₹ "+Number(e||0).toLocaleString("en-IN",{maximumFractionDigits:0})},69806:(e,t,i)=>{i.d(t,{F:()=>r,W:()=>a});var o=i(16594);function a({orderId:e,items:t,address:i,payment:a,totals:r,etaText:s}){let l=t.map(e=>{let t=e.price*e.qty,i=e.originalPrice&&e.originalPrice>e.price,a=i?e.originalPrice*e.qty:null;return`
      <tr>
        ...
        <td style="padding:14px 0;border-bottom:1px solid #ece4d6;text-align:right;vertical-align:top;white-space:nowrap">
          ${i?`<div style="font-size:12px;color:#9c9080;text-decoration:line-through;margin-bottom:2px">${(0,o.C)(a)}</div>`:""}
        ...
        <tr>
          <td style="padding:36px">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0 0">
              <tr>
                ...
                <td style="padding:18px;background:#f5f0e8;border-left:1px solid #ece4d6">
                  ...
                  <div style="font-size:18px;letter-spacing:0.12em;margin-top:6px;color:#c94f2a;font-weight:700">${(0,o.C)(r.total)}</div>
                </td>
              </tr>
              <tr>
                ...
                <td style="padding:18px;background:#f5f0e8;border-top:1px solid #ece4d6;border-left:1px solid #ece4d6">
                  ...
                  <div style="font-size:14px;margin-top:6px">${n(a)}</div>
                </td>
              </tr>
            </table>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:18px">
              ${r.savings>0?`
              <tr><td style="padding:6px 0;color:#2a2a2a;font-size:14px">MRP Total</td><td style="padding:6px 0;text-align:right;font-size:14px;color:#9c9080;text-decoration:line-through">${(0,o.C)(r.subtotal+r.savings)}</td></tr>
              <tr><td style="padding:6px 0;color:#c94f2a;font-size:14px;font-weight:600">Sale Savings</td><td style="padding:6px 0;text-align:right;font-size:14px;color:#c94f2a;font-weight:600">− ${(0,o.C)(r.savings)}</td></tr>`:""}
              <tr><td style="padding:6px 0;color:#2a2a2a;font-size:14px">Subtotal</td><td style="padding:6px 0;text-align:right;font-size:14px">${(0,o.C)(r.subtotal)}</td></tr>
              <tr><td style="padding:6px 0;color:#2a2a2a;font-size:14px">Shipping</td><td style="padding:6px 0;text-align:right;font-size:14px;color:${0===r.shipping?"#c94f2a":"#0a0a0a"}">${0===r.shipping?"Free":(0,o.C)(r.shipping)}</td></tr>
              ...
              <tr>
                ...
                <td style="padding:8px 0;text-align:right;font-weight:700;font-size:18px;color:#c94f2a">${(0,o.C)(r.total)}</td>
              </tr>
              ${r.savings>0?`
              <tr><td colspan="2" style="padding:10px 0 0;text-align:right;font-size:12px;color:#c94f2a;font-style:italic">You saved ${(0,o.C)(r.savings)} on this order ✦</td></tr>`:""}
            </table>
            ...
            <p style="margin:0;color:#2a2a2a;font-size:14px;line-height:1.85">
              <strong>${n(i.fullName)}</strong><br>
              ${n(i.address)}${i.address2?"<br>"+n(i.address2):""}<br>
              ${n(i.city)}, ${n(i.state)} ${n(i.pincode)}<br>
              ${n(i.phone)}
            </p>
...
</body></html>`}function n(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}},89484:(e,t,i)=>{i.d(t,{KU:()=>s,Mu:()=>l,X8:()=>p,aB:()=>d});let o=globalThis;o.__shankyOtp||(o.__shankyOtp=new Map),o.__shankyVerified||(o.__shankyVerified=new Map);let a=o.__shankyOtp,r=o.__shankyVerified,n=e=>String(e||"").trim().toLowerCase();function s(e){let t=String(Math.floor(1e5+9e5*Math.random()));return a.set(n(e),{code:t,expires:Date.now()+6e5,attempts:0}),t}function l(e,t){let i=n(e),o=a.get(i);return o?Date.now()>o.expires?(a.delete(i),{ok:!1,reason:"Code expired. Request a new one."}):(o.attempts+=1,o.attempts>6)?(a.delete(i),{ok:!1,reason:"Too many attempts. Request a new code."}):o.code!==String(t).trim()?{ok:!1,reason:"Incorrect code."}:(a.delete(i),{ok:!0}):{ok:!1,reason:"No code requested for this email."}}function d(e){r.set(n(e),Date.now()+18e5)}function p(e){let t=n(e),i=r.get(t);return!!i&&(!(Date.now()>i)||(r.delete(t),!1))}}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),o=t.X(0,[948,972,381],()=>i(11864));module.exports=o})();