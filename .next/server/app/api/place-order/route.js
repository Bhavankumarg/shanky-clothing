"use strict";(()=>{var e={};e.id=398,e.ids=[398],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},89750:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>h,patchFetch:()=>y,requestAsyncStorage:()=>m,routeModule:()=>f,serverHooks:()=>u,staticGenerationAsyncStorage:()=>x});var a={};r.r(a),r.d(a,{POST:()=>g,runtime:()=>c});var o=r(49303),i=r(88716),n=r(60670),s=r(87070),l=r(89484),d=r(16594),p=r(69806);let c="nodejs";async function g(e){let t;try{t=await e.json()}catch{return s.NextResponse.json({ok:!1,error:"Invalid request body"},{status:400})}let{email:r,items:a,address:o,payment:i,totals:n}=t||{};if(!r||!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(r))return s.NextResponse.json({ok:!1,error:"A valid email is required."},{status:400});if(!(0,l.X8)(r))return s.NextResponse.json({ok:!1,error:"Please verify your email before placing the order."},{status:401});if(!Array.isArray(a)||0===a.length)return s.NextResponse.json({ok:!1,error:"Your bag is empty."},{status:400});if(!o?.fullName||!o?.address||!o?.city||!o?.pincode)return s.NextResponse.json({ok:!1,error:"Address is incomplete."},{status:400});let c="SHK-"+Math.random().toString(36).slice(2,8).toUpperCase(),g=new Date,f=new Date(g.getTime()+432e6),m=e=>e.toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"}),x=`${m(g)} – ${m(f)}`,u=(0,p.W)({orderId:c,items:a,address:o,payment:i||"Online",totals:{subtotal:Number(n?.subtotal||0),shipping:Number(n?.shipping||0),total:Number(n?.total||0)},etaText:x}),h=await (0,d.y)({to:r,subject:`Your Shanky order ${c} is confirmed ✦`,html:u,text:`Your Shanky order ${c} has been confirmed. Total: ₹${n?.total}. Estimated delivery: ${x}.`});return h.ok?s.NextResponse.json({ok:!0,orderId:c,emailSent:!0,dev:!!h.dev}):s.NextResponse.json({ok:!0,orderId:c,emailSent:!1,warning:h.error||"Email could not be sent."})}let f=new o.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/place-order/route",pathname:"/api/place-order",filename:"route",bundlePath:"app/api/place-order/route"},resolvedPagePath:"/Users/bhavankumarganesan/sst-projetcs/void-store/app/api/place-order/route.js",nextConfigOutput:"",userland:a}),{requestAsyncStorage:m,staticGenerationAsyncStorage:x,serverHooks:u}=f,h="/api/place-order/route";function y(){return(0,n.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:x})}},16594:(e,t,r)=>{r.d(t,{C:()=>l,y:()=>s});var a=r(82591);let o=process.env.RESEND_API_KEY,i=process.env.EMAIL_FROM||"Shanky <onboarding@resend.dev>",n=o?new a.R(o):null;async function s({to:e,subject:t,html:r,text:a}){if(!n)return console.log("\n\uD83D\uDCE7 [DEV] Email skipped (no RESEND_API_KEY)."),console.log("   To     :",e),console.log("   Subject:",t),a&&console.log("   Body   :",a.slice(0,400)),{ok:!0,dev:!0};try{let{data:o,error:s}=await n.emails.send({from:i,to:Array.isArray(e)?e:[e],subject:t,html:r,text:a});if(s)return console.error("Resend error:",s),{ok:!1,error:s.message||"Email send failed"};return{ok:!0,id:o?.id}}catch(e){return console.error("Resend threw:",e),{ok:!1,error:e.message||"Email send failed"}}}let l=e=>"₹ "+Number(e||0).toLocaleString("en-IN",{maximumFractionDigits:0})},69806:(e,t,r)=>{r.d(t,{F:()=>i,W:()=>o});var a=r(16594);function o({orderId:e,items:t,address:r,payment:o,totals:i,etaText:s}){let l=t.map(e=>`
      <tr>
        ...
        <tr>
          <td style="padding:36px">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0 0">
              <tr>
                ...
                <td style="padding:18px;background:#f5f0e8;border-left:1px solid #ece4d6">
                  ...
                  <div style="font-size:18px;letter-spacing:0.12em;margin-top:6px;color:#c94f2a;font-weight:700">${(0,a.C)(i.total)}</div>
                </td>
              </tr>
              <tr>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:18px">
              <tr><td style="padding:6px 0;color:#2a2a2a;font-size:14px">Subtotal</td><td style="padding:6px 0;text-align:right;font-size:14px">${(0,a.C)(i.subtotal)}</td></tr>
              <tr><td style="padding:6px 0;color:#2a2a2a;font-size:14px">Shipping</td><td style="padding:6px 0;text-align:right;font-size:14px;color:${0===i.shipping?"#c94f2a":"#0a0a0a"}">${0===i.shipping?"Free":(0,a.C)(i.shipping)}</td></tr>
              ...
              <tr>
                ...
                <td style="padding:8px 0;text-align:right;font-weight:700;font-size:18px;color:#c94f2a">${(0,a.C)(i.total)}</td>
              </tr>
            </table>
...
</body></html>`}function i(e){return`<!doctype html>
...
</body></html>`}function n(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}},89484:(e,t,r)=>{r.d(t,{KU:()=>s,Mu:()=>l,X8:()=>p,aB:()=>d});let a=globalThis;a.__shankyOtp||(a.__shankyOtp=new Map),a.__shankyVerified||(a.__shankyVerified=new Map);let o=a.__shankyOtp,i=a.__shankyVerified,n=e=>String(e||"").trim().toLowerCase();function s(e){let t=String(Math.floor(1e5+9e5*Math.random()));return o.set(n(e),{code:t,expires:Date.now()+6e5,attempts:0}),t}function l(e,t){let r=n(e),a=o.get(r);return a?Date.now()>a.expires?(o.delete(r),{ok:!1,reason:"Code expired. Request a new one."}):(a.attempts+=1,a.attempts>6)?(o.delete(r),{ok:!1,reason:"Too many attempts. Request a new code."}):a.code!==String(t).trim()?{ok:!1,reason:"Incorrect code."}:(o.delete(r),{ok:!0}):{ok:!1,reason:"No code requested for this email."}}function d(e){i.set(n(e),Date.now()+18e5)}function p(e){let t=n(e),r=i.get(t);return!!r&&(!(Date.now()>r)||(i.delete(t),!1))}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[948,972,591],()=>r(89750));module.exports=a})();