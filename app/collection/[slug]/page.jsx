...
import { getProduct, formatPrice, relatedProducts } from '@/lib/products'
        ...
        <div className="pdp-info">
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            {product.badge && (
              <span
                style={{
                  background: '#c94f2a', color: '#f5f0e8',
                  fontSize: '0.62rem', letterSpacing: '0.22em', padding: '3px 8px',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
              ...
              <Link
                ...
                style={{
                  ...
                  color: '#c94f2a', textDecoration: 'underline', textUnderlineOffset: 4,
                }}
              >
                Size guide
              </Link>
          ...
          <div className="benefits">
            <div className="benefit">
              ...
              <span className="benefit-label">30-Day Returns</span>
            </div>
            <div className="benefit">
              <span className="benefit-icon">✦</span>
              <span className="benefit-label">Free Shipping</span>
            </div>
            <div className="benefit">
              <span className="benefit-icon">∞</span>
              <span className="benefit-label">Lifetime Mend</span>
            </div>
          </div>
          ...
          <div className="pdp-section">
            ...
            <div className={`acc-item ${openAcc === 'fit' ? 'open' : ''}`}>
              ...
              <div className="acc-content">
                <p>
                  Designed for an oversized, relaxed silhouette. Model is 5'10" and wears size S. For a closer fit, size down. Refer to the size guide for detailed measurements.
                </p>
              </div>
            </div>
            <div className={`acc-item ${openAcc === 'ship' ? 'open' : ''}`}>
              ...
              <div className="acc-content">
                <p>
                  Free shipping across India on orders over ₹4,999. International shipping calculated at checkout. Returns accepted within 30 days, unworn and tagged. Sale items final.
                </p>
              </div>
            </div>
          </div>
